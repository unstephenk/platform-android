...
/**
 * Interface for add media use case. Should be implemented by add media concrete class.
 *
 * @author Ushahidi Team <team@ushahidi.com>
 */
public interface IAddMedia extends IInteractor {

    /**
     * Executes this use case.
     *
     * @param media    The media to be added.
     * @param callback A {@link com.ushahidi.android.core.usecase.media.IAddMedia.Callback} used for
