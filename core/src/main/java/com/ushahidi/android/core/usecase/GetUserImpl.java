...
/**
 * This class is an implementation of {@link GetUser} that represents a use case for
...
public class GetUserImpl implements GetUser{
    ...
    public GetUserImpl(UserRepository userRepository, ThreadExecutor threadExecutor,
