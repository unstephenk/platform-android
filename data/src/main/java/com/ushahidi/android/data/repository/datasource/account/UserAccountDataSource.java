...
public interface UserAccountDataSource {
     ...
     * @param callback          A {@link UserAccountEntityLoggedInCallback} used for notifying
     *                          clients about the delete status.
     */
    void loginUserAccountEntity(final UserAccountEntity userAccountEntity,
            UserAccountEntityLoggedInCallback callback);

    /**
     * Callback used for notifying the client when either a user has been deleted or failed to be
     * deleted.
     */
    interface UserAccountEntityLoggedInCallback {

        void onUserAccountEntityLoggedIn(UserAccountEntity userAccountEntity);
