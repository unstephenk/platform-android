 ...
 * <p/> RecyclerView.OnItemTouchListener that allows items to be swiped and dismissed. <p/> Typical
 * usage: <p/>
 * <pre>
 * {@code
 * swipeToDismissTouchListener = new SwipeToDismissTouchListener(recyclerView, new
 * SwipeToDismissTouchListener.DismissCallbacks() {
 *           @Override
 *          public SwipeToDismissTouchListener.SwipeDirection canDismiss(int position) {
 *              return SwipeToDismissTouchListener.SwipeDirection.RIGHT;
 *          }
 *           @Override
 *          public void onDismiss(RecyclerView view, List<SwipeToDismissTouchListener.PendingDismissData>
 * dismissData) {
