...
/**
 * Presenter for {@link com.ushahidi.android.ui.activity.PostActivity} to facilitate communication
 * between it and the {@link com.ushahidi.android.model.PostModel}
 *
...
public class PostPresenter implements IPresenter {
    ...
    public interface View extends IView {
        ...
        void setUserProfiles(List<UserModel> userProfiles);

        void setActiveUserProfile(UserModel userProfile);
    }
}
